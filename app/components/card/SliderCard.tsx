...
const SliderCard = () => {
  ...
  return (
    <section className="bg-white rounded-xl text-productHives-TextSecondary">
      <article className="grid grid-cols-2 px-10 relative overflow-hidden p-2 z-20">
      ...
      <div className="grid grid-cols-2 items-center px-10 relative overflow-hidden z-20 p-5">
